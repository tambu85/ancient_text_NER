...
def annotate(text, gcube_token=None, lang=DEFAULT_LANG, categories=True, api=DEFAULT_TAG_API,
    ...
    :param epsilon: [0,0.5] low value for context --- high value for common topics
    '''
